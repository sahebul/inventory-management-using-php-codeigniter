  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?=admin_url("dashboard")?>">
        ...
        <div class="sidebar-brand-text mx-3">Imventory <sup>Management</sup></div>
      </a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Your Website 2019</span><br/>
            <span>Develope by Sahebul</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?=admin_url('admin/login/logout')?>">Logout</a>
        </div>
      </div>
    </div>
  </div>
