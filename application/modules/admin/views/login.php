                ...
                <div class="p-5">
                  ...
                  <form class="user" action="<?php echo base_url("admin/login/login_process"); ?>" method="post">
                    <div class="form-group">
                      <input type="input"  name="username" value="<?php echo set_value('username');?>" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Email Address...">
